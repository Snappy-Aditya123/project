...
#     # Add jobs
#     db.add_job("Software Engineer", "TechCorp", "London", 60000, 80000, "Develop and maintain software.")
#     db.add_job("Data Analyst", "Data Inc.", "New York", 50000, 70000, "Analyze data to generate insights.")

#     # Retrieve jobs
#     jobs = db.retrieve_jobs()
#     print("All Jobs:")
#     for job in jobs:
#         print(job)

#     # Retrieve jobs with a filter
#     filtered_jobs = db.retrieve_jobs("location = 'London'")
#     print("\nJobs in London:")
#     for job in filtered_jobs:
#         print(job)

#     # Delete a job by ID
#     db.delete_job(1)  # Delete the job with ID 1
